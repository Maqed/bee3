...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 mb-5 flex flex-col justify-between gap-1 border-b border-border/50 bg-background/80 py-4 shadow-sm backdrop-blur-md">
