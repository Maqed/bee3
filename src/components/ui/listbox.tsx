...
>(({ className, ...props }, ref) => (
  <ListboxPrimitive.Item
    ...
    ref={ref}
    className={cn(
      "outline-hidden data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-50 flex w-full cursor-default select-none items-center justify-between gap-2 rounded-md p-4 ring-1 ring-border focus-visible:ring-ring",
      className,
    )}
    {...props}
  />
